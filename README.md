...
1. VDD\_CORE, ADC\_BGREF, ADC\_INPUT\_VDDIO.
...
4. The user can notice the raw sample values and voltage values in the terminal emulation tool. The GPIO pin is connected to user button on the Evaluation kit to check the value during button press and release.
